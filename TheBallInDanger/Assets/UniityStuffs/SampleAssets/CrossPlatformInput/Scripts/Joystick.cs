...
public class Joystick : MonoBehaviour , IPointerUpHandler , IPointerDownHandler , IDragHandler {
	...
	private void CreateVirtualAxes()
	{
		...
		if (useX)
		    ...
		    //horizontalVirtualAxis = new CrossPlatformInputManager.VirtualAxis(horizontalAxisNameLook);
		if (useY)
			verticalVirtualAxis = new CrossPlatformInputManager.VirtualAxis(verticalAxisName);
		    //verticalVirtualAxis = new CrossPlatformInputManager.VirtualAxis(verticalAxisNameLook);
	}
